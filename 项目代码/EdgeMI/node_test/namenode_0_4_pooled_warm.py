...
def run_distributed_inference_pooled(namenode, round_idx):
    """运行单轮 pooled 推理（带完整时间统计）"""
    print(f"\n========== 第 {round_idx} 轮运行 (Pooled) ==========")
...
if __name__ == "__main__":
    ...
    for round_idx in range(1, TOTAL_ROUNDS + 1):
        run_distributed_inference_pooled(namenode, round_idx)
