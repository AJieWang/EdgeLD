...
class VGG_model(nn.Module):
    def __init__(self, num_classes = 100, init_weights = True):
        ...
        self.module_list.append(self.features_3_4) #9
        self.module_list.append(self.features_4_1) #10
        self.module_list.append(self.features_4_2) #11
        self.module_list.append(self.features_4_4) #12
        self.module_list.append(self.features_5_1) #13
        self.module_list.append(self.features_5_2) #14
        self.module_list.append(self.features_5_4) #15
        self.module_conv_length = len(self.module_list) - 1
        # 以下为 “全连接层”
        self.module_list.append(self.classifier_1)  # 16
        self.module_list.append(self.classifier_2)  # 17
        self.module_list.append(self.classifier_3)  # 18
        # 统计 “卷积层” 和 “全连接层” 的长度
...
if __name__ == '__main__':
    ...
    VGG13_model = VGG_model()
    input = torch.rand(1, 512 * 7 * 7)
    conv_length = VGG13_model.get_conv_length()
    ...
    # start_time = time.time()
    # for i in range(count):
    #     output = VGG13_model(input, 1, total_length)
    # end_time = time.time()
    # print("One inference used time: %.4fs" %((end_time - start_time)/count) )
