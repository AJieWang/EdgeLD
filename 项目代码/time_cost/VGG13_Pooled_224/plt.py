...
for i in range(10):
    ...
    if i % 2 == 0:
        ...
        conv_stages_odd['namenode transfer_time'].append(avg_data['namenode_transfer_time'][data_idx])
        conv_stages_odd['datanode pre_conv'].append(avg_data['datanode_pre_conv_pool'][data_idx])
        conv_stages_odd['datanode conv_time'].append(avg_data['datanode_conv_pool_time'][data_idx])
    else:
