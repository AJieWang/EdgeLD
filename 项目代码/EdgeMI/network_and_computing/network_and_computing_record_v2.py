...
class Network_And_Computing():
    def __init__(self):
        ...
        # 各节点物理内存大小 (bytes)，默认4个节点，每个1GB
        self.memory_state = [1e9, 1e9, 1e9, 1e9, 1e9, 1e9, 1e9]
    ...
    def get_memory_state(self, datanode_num = 1):
        return self.memory_state[0: datanode_num]
